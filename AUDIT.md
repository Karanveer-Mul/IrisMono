...
| §1 | Isolated GPU worker containers via message queue | ⚠️ Partial | Now containerized — see "Containerized GPU worker" in §7 — but the model itself remains simulated, which is this project's own stated scope rather than a gap |
